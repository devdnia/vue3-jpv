<template>
  <div class="banner-1 flex h-full items-center">
    <div class="w-7/12 p-12">
      <h2 class="text-gray-700 md:text-6xl text-2xl font-Eczar mb-5 font-bold mt-14">
        Trabajemos juntos y hagamos que todo vaya perfecto
      </h2>
      <div class="mt-5">
        <span class="text-gray-700 md:text-6xl text-2xl font-Eczar mb-5 font-bold">📱 666 666 666 </span>
      </div>
    </div>
